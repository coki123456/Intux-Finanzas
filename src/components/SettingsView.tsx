...
const SettingsView: React.FC<SettingsViewProps> = ({ partnerNames, onUpdateNames }) => {
    ...
    return (
        <div className="max-w-2xl mx-auto space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
            <div>
                ...
                <p className="text-zinc-500 mt-1">Gestiona los nombres de los socios y datos de la aplicación.</p>
            </div>
            ...
            <div className="bg-white rounded-2xl border border-zinc-200 shadow-sm overflow-hidden p-6 space-y-6">
                <h2 className="text-lg font-semibold text-zinc-900">Nombres de Socios</h2>

                <div className="grid gap-4 md:grid-cols-2">
                    <div className="space-y-2">
                        <label className="text-sm font-medium text-zinc-700">Nombre Socio A</label>
                        <input
                            type="text"
                    ...
                    <div className="space-y-2">
                        <label className="text-sm font-medium text-zinc-700">Nombre Socio B</label>
                        <input
                            type="text"
